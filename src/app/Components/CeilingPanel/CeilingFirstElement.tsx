...
const CeilingFirstElement = () => (
  <div className="main_section additional_padding">
    ...
    <p className="pt-4 xl:max-w-[70%]">
      Panely sú určené najmä pre stropné a strešné konštrukcie. Ich všestrannosť
      spočíva v tom, že môžu byť uložené ako prostý nosník, ale dajú sa použiť
      aj pre konzolové uloženie. Technológia prepínacích lán umožňuje dosihnuť
      nadvýšenie panelov (max. l/300), ktoré sa stanovuje v závislosti od
      viacerých faktorov.
    </p>
    <p className="pt-8 xl:max-w-[70%]">
      ...
      podlahy minimálne 60 milimetrov, čím sa zabezpečí nielen stabilita, ale aj
